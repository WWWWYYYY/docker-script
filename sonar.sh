...
docker run --name sq -d --link db -e SONARQUBE_JDBC_URL=jdbc:postgresql://db:5432/sonar  -e SONARQUBE_JDBC_USERNAME=sonar -e SONARQUBE_JDBC_PASSWORD=sonar -p 9000:9000 -v sonarqube-data:/opt/sonarqube/data -v sonarqube-log:/opt/sonarqube/log -v sonarqube-extensions:/opt/ -v /etc/localtime:/etc/localtime:ro sonarqube/extensions sonarqube
